...
//	}	
	 ...
	 */
	public boolean isStopWord(char[] charArray , int begin, int length){	
		if(!singleton._StopWordDict.match(charArray, begin, length).isMatch()){
			return singleton._StopWordDict.stopwordMap.get(new String(charArray,begin,length))==null?false:true;
		}
		return singleton._StopWordDict.match(charArray, begin, length).isMatch();
	}	
