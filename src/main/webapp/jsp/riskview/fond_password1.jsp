...
<title>找回密码</title>
	...
	<link rel="stylesheet" type="text/css" href="common/css/fond_password1.css"/>
...
<!-- body -->
<div class="content">
<form id="fond1_form" name="fond1_form" method="post">

	<h1><img src="common/img/fond_password1.png"/></h1>	
	<div  class="form_bx">
		<div>手机号：
		<input id="userPhone" name="userPhone" type="text" class="password_old" placeholder="输入手机号"  onfocus="this.placeholder=''" onblur="this.placeholder='输入手机号'" />
		<input id="userType" name="userType" type="hidden" value="1" />
		</div>
		<div class="d8">验证码：
		<!--<input id="verifyCode" name="verifyCode" type="text" style="width:124px" class="email_new" placeholder="输入验证码"  onfocus="this.placeholder=''" onblur="this.placeholder='输入验证码'"/><input type="hidden"/>
		  <img id="kaptchaImage" name="kaptchaImage" alt="验证码" src="risk/view/getVerificationCode.do"> -->
		...
		<img id="kaptchaImage" name="kaptchaImage" title="点击更换验证码" src="risk/view/getVerificationCode.do"   onclick="this.src='risk/view/getVerificationCode.do';">
		</div>
		<div id="text_tip"></div>
