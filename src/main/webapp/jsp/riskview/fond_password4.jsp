...
<title>找回密码</title>
	...
	<link rel="stylesheet" type="text/css" href="common/css/fond_password4.css"/>
...
<!-- body -->
<div class="content">
<form id="fond4_form" name="fond4_form" method="post">

	<h1><img src="common/img/fond_password4.png"/></h1>	
	<div  class="form_bx">
		<div class="style"><img src="common/img/yes_ico.png"/>恭喜您，修改密码成功！</div>		
		<div id="text_tip"></div>
		<div><a class="abtn">完成</a></div>
	</div>
