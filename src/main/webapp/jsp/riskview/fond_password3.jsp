...
<title>找回密码</title>
	...
	<link rel="stylesheet" type="text/css" href="common/css/fond_password3.css"/>
...
<!-- body -->
<div class="content">
<form id="fond3_form" name="fond3_form" method="post">

	<h1><img src="common/img/fond_password3.png"/></h1>	
	<div  class="form_bx">
		<div >输入新密码：<input id="user_password" name="user_password" type="password" class="password_old" placeholder="请设置6-18位登录密码"  onfocus="this.placeholder=''" onblur="this.placeholder='请设置6-18位登录密码'" /></div>
		<div >确认新密码：<input id="user_password2" name="user_password2" type="password" class="email_new" placeholder="请再次输入您的密码"  onfocus="this.placeholder=''" onblur="this.placeholder='请再次输入您的密码'"  /></div>
		<div id="text_tip"></div>
		<div><a class="abtn">提交修改</a></div>
	</div>
