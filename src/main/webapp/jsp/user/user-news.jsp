...
<body>
		...
		<div class="bg">
			...
			<c:if test="${user!=null}">
				<ul class="hideUl" onMouseLeave="hideHeadUl();" style="right:10px;"
					onClick="hideHeadUl();">
					<li class="line"><a href="user/myfavorite.do">我的文库</a></li>
	...
	<div name="header2" class="header2"
		...
		<ul class="ul" style="float:right;height:40px;">
			...
			</span> <input type="hidden" id="searchNews" value="news">
			</li>
		</ul>
	</div>
	<!-- header_end -->
	...
	<div class="userCont">
		...
		<div class="newsContent" >
			<div class="left" >
				<h4 class="title">${content.contentName}</h4>
				<div class="t_content">
				...
				<div class="bshare-custom" style="">
					...
					分享到： <a title="分享到新浪微博" class="bshare-sinaminiblog"></a> <a
						title="分享到QQ空间" class="bshare-qzone"></a> <a title="分享到腾讯微博"
						class="bshare-qqmb"></a> <a
						style="display:inline-block;background:url(http://static.bshare.cn/frame/images//logos/s4/weixin.png) no-repeat;"
						onclick="javascript:bShare.share(event,'weixin');return false;"
						title="分享到微信" href="javascript:;"></a> <a
						style="display:inline-block;background:url(word/img/email.png) no-repeat;"
						onclick="javascript:bShare.share(event,'email');return false;"
						title="分享到邮箱" href="javascript:;"></a> <a title="更多平台"
						style="display:inline-block;background:url(word/img/more-style-addthis.png) no-repeat;"
