...
<div class="userCont">
    ...
    <div class="clearfix userBody">
        ...
        <div class="userRight">
            <h1>我的新闻<span class="dele"  onClick="delpre();">删除</span></h1>
            <div class="userR_ news_">
                <h2>
                    <input type="checkbox" class="allCheck">
                    <span>类型</span><span style="width:320px; padding-left:116px">标题</span><span style="width:175px;padding-left:70px;"><span>状态</span>
                ...
                <ul class="news_ul">
                	<c:forEach items="${page.list}" var="content">
                    	<li>
	                        ...
	                        <span class="type_ type_4"></span> 
	                        <a target="_blank" href="user/news.do?newsId=${content.contentId}" class="w450" title="${content.contentName}">
	                        ...
	                        <span class="state">
	                        	<c:if test="${content.passType=='SAVED'}">私有</c:if>
	                        	<c:if test="${content.passType=='PASSED'}">公开</c:if>
	                        </span> 
