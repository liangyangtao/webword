...
<div name="banner" class="banner">
	...
	<ul class="ul">
		<li class="li2"><input class="search_input" type="text"
			...
			onblur="if(this.value==''){this.placeholder='这里搜索您关注的资讯'}"> <span><a
				class="search">搜&nbsp;&nbsp;索</a> </span>
		</li>
		<li class="li3"><label><input class="input1" type="radio"
				name="searchType" value="ALL">&nbsp;新闻全文</label> <label><input
				type="radio" name="searchType" value="TITLE">&nbsp;新闻标题</label></li>

	</ul>
	<ul class="tabUl">
		<li class="current"><a href="news/view/index.do">新闻</a></li>
		<li><a href="view/home.do">文档</a></li>
		<li>数据</li>
		<li>视频</li>
	</ul>
</div>
