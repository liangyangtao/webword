    ...
    RemoteImage.prototype = {
        ...
        setPreview: function(){
            ...
            if(url) {
            	//zhu
            	var imgurl=url;
            	if(url.substring(0,4)!="http"){//超链接
            		imgurl="../.."+url.split("ueditor")[1];
            	}
                preview.innerHTML = '<img src="' + imgurl + '" width="' + width + '" height="' + height + '" border="' + border + 'px solid #000" title="' + title + '" />';
            }
        },
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    img.width = 113;
                    //zhu
                    var imgurl=list[i].url.split('ueditor')[1];
            ...
            for (i = 0; i < lis.length; i++) {
                if (domUtils.hasClass(lis[i], 'selected')) {
                    var img = lis[i].firstChild,
                        src = "ueditor"+img.getAttribute('_src');//zhu
                    list.push({
                        src: src,
                        _src: src,
